...
namespace Employee_MS
{
    public partial class Employee : Form
    {
        ...
        //        {
        //            Con.Open();
        //            string query = "update ETBL set EmpId='" + textBox1.Text + "',EmpName = '" + textBox2.Text + "', EmpAdd='" + textBox3.Text + "',EmpPos= '" + comboBox2.Text + "', EmpDob='" + dateTimePicker1.Value.Date + "', EmpPhone='" + textBox4.Text + "', EmpGen='" + comboBox1.Text + "', EmpEdu='" + comboBox4.Text + "';";
        //            SqlCommand cmd = new SqlCommand(query, Con);
        //            cmd.ExecuteNonQuery();
        //            Con.Close();
